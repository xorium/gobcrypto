...
// ErrMismatchedHashAndPassword is the error returned from CompareHashAndPassword when a
//password and hash do
// not match.
var ErrMismatchedHashAndPassword = errors.New("crypto/bcrypt: hashedPassword is not the hash of the given password")

// ErrHashTooShort is the error returned from CompareHashAndPassword when a hash is too
//short to
// be a bcrypt hash.
var ErrHashTooShort = errors.New("crypto/bcrypt: hashedSecret too short to be a bcrypted password")

// HashVersionTooNewError is the error returned from CompareHashAndPassword when a hash
//was/created with
...
// InvalidHashPrefixError is the error returned from CompareHashAndPassword when a hash
